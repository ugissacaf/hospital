   ...
   <div class="container">
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
           <div class="container-fluid">
               <a href="dokter.php" class="navbar-brand">Hospital</a>
...
?>
    <tr>
        ...
        <td><?= $data['nmKunjungan']; ?></td>
        <td><?= $data['jk']; ?></td>
        <td><?= $data['alamat']; ?></td>
        <td>
            <a href="editdokter.php?edit=<?= $data['idKunjungan']; ?>" class="btn btn-warning btn-sm">Edit</a>
            <a href="koneksi.php?idDokter=<?= $data['idKunjungan']; ?>" class="btn btn-danger btn-sm">Hapus</a>
        </td>
    </tr>
<?php
}
